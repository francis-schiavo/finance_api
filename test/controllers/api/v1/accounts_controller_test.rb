    ...
    class AccountsControllerTest < ActionDispatch::IntegrationTest
      ...
      test 'should create account' do
        assert_difference('::Account.count') do
          post api_v1_accounts_url, params: { account: @account_data }, as: :json
        end
      ...
      test 'should not create account without a person' do
        assert_no_difference('::Account.count') do
          post api_v1_accounts_url, params: { account: @account_data.except('person_id') }, as: :json
        end
      ...
      test 'should not create account without a balance' do
        assert_no_difference('::Account.count') do
          post api_v1_accounts_url, params: { account: @account_data.except('balance') }, as: :json
        end
      ...
      test 'should update api_v1_account' do
        patch api_v1_account_url(@account), params: { account: @account_data }, as: :json
